...
import { HStack, Alert, AlertIcon, Button } from '@chakra-ui/react';
...
<HStack gap="4">
  ...
  <Link to="https://www.instagram.com/desktopofsamuel/">
...
<Alert status="info">
  <AlertIcon />
  <p>
    最近喜愛的東西已搬到<a href="/">主頁</a>，如何將網誌連結到 Spotify,
    Letterboxd 等平台，可參考這篇
    <a href="/posts/gatsby-個人狀況自動更新-整合spotify音樂-letterboxd電影-書本紀錄/">
      技術分享
    </a>
  </p>
</Alert>
