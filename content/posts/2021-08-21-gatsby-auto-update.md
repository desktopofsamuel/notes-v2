...
category: 桌面
socialImage: /media/auto-update-dashboard.png
tags:
  - Gatsby
  - React
  - Spotify
...
網上不少 creator 的個人網頁也有更加先進的整合，如 [Fabrizio Rinaldi](https://www.fabrizio.so/) 整合了自己網頁的即時使用數據和個人 Project 的每月收入。[Nev Flynn](https://nevflynn.com/)，會即時顯示自己正在聽的歌和現在位置。這次也向他們偷師，顯示我最近的音樂、電影和書本資訊。

![](/media/auto-update-dashboard.png)
...
![](/media/auto-update-rss-feedly.png)

`gatsby-source-rss-feed` 這插件就是為 RSS Feed 而設，每次 Build 網頁的時候都會讀取該 Feed。
